    ...
    return (
        <div class="relative z-0 w-full  group ">
            <input
                ...
                class={`block ${shadow ? shadow : 'shadow-[#b6b6b6]'} bg-white shadow-xl  py-2.5  w-full text-[12px] text-gray-900 bg-transparent  px-5 border border-[#dddddd] appearance-none  focus:outline-none focus:ring-0  peer rounded-[5px]`} />
